...
public class ANTSSimpleAntModel extends ANTSAbstractModel implements ANTSIModel 
{
	...
	public ANTSSimpleAntModel(double posX, double posY, double radius, Color color)
	{
		this.matrix = new AffineTransform();
	...
	public ANTSSimpleAntModel(double posX, double posY, double radius, Color color, boolean isMouseListener)
	{
		this.matrix = new AffineTransform();
