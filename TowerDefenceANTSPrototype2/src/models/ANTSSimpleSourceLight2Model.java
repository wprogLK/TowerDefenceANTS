...
public class ANTSSimpleSourceLight2Model extends ANTSAbstractModel implements ANTSIModel 
{
	...
	public ANTSSimpleSourceLight2Model(double posX, double posY, double radius, Color color, boolean isMouseListener, ANTSFactory factory)
	{
		super(factory);
